...
({
    ...
    template :
    `
    <form class="tn-input-container tn-email" name="form" [class.tn-input-status-verified]="isVerified()" [class.tn-input-status-error]="isError()" [class.tn-input-status-rounded]="roundedIcons">
