...
$ curl "https://api.mapbox.com/geocoding/v5/mapbox.places/-73.989,40.733.json?access_token=***REMOVED-MAPBOX-TOKEN***"

# Filter results to only include points of interest

$ curl "https://api.mapbox.com/geocoding/v5/mapbox.places/-73.989,40.733.json?types=poi&access_token=***REMOVED-MAPBOX-TOKEN***"
*/
}
