...
export class ActionClusterEventsReset   { static readonly type = ActionsClusterEvents.Reset; }
export class ActionClusterEventsGetData { static readonly type = ActionsClusterEvents.GetData; }
export class ActionClusterEventsGet     { static readonly type = ActionsClusterEvents.Get; }
...
export class ActionClusterEventsFilter  { static readonly type = ActionsClusterEvents.Filter; }
