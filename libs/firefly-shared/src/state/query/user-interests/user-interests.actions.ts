...
export class ActionUserInterestsReset   { static readonly type = ActionsUserInterests.Reset; }
export class ActionUserInterestsGetData { static readonly type = ActionsUserInterests.GetData; }
export class ActionUserInterestsGet     { static readonly type = ActionsUserInterests.Get; }
