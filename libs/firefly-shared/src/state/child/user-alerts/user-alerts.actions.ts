...
export class ActionUserAlertsReset   { static readonly type = ActionsUserAlerts.Reset; }
export class ActionUserAlertsGetData { static readonly type = ActionsUserAlerts.GetData; }
...
export class ActionUserAlertsGet     { static readonly type = ActionsUserAlerts.Get; }
...
export class ActionUserAlertsGetIcons         { static readonly type = ActionsUserAlerts.GetIcons; }
export class ActionUserAlertsGetImages        { static readonly type = ActionsUserAlerts.GetImages; }
