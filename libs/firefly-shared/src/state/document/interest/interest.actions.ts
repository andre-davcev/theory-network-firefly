...
export class ActionInterestCreate        { static readonly type = ActionsInterest.Create; }
export class ActionInterestUpdate        { static readonly type = ActionsInterest.Update; }
export class ActionInterestSave          { static readonly type = ActionsInterest.Save; }
export class ActionInterestDelete        { static readonly type = ActionsInterest.Delete; }
export class ActionInterestSetId         { static readonly type = ActionsInterest.SetId;         constructor(public id: string = CoreEnum.IdNew) { } }
export class ActionInterestImagesUpdate  { static readonly type = ActionsInterest.ImagesUpdate; }
export class ActionInterestImageSet      { static readonly type = ActionsInterest.ImageSet; }

export class ActionInterestEventsGet          { static readonly type = ActionsInterest.EventsGet; }
export class ActionInterestEventsGetPending   { static readonly type = ActionsInterest.EventsGetPending; }
export class ActionInterestEventsGetAnonymous { static readonly type = ActionsInterest.EventsGetAnonymous; }
