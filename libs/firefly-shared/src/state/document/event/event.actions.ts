...
export class ActionEventReset         { static readonly type = ActionsEvent.Reset; }
...
export class ActionEventCreate        { static readonly type = ActionsEvent.Create; }
export class ActionEventUpdate        { static readonly type = ActionsEvent.Update; }
export class ActionEventSave          { static readonly type = ActionsEvent.Save; }
export class ActionEventDelete        { static readonly type = ActionsEvent.Delete; }
...
export class ActionEventImagesUpdate   { static readonly type = ActionsEvent.ImagesUpdate; }
export class ActionEventImageSet       { static readonly type = ActionsEvent.ImageSet; }
...
export class ActionEventDeny           { static readonly type = ActionsEvent.DenyEvent; }
