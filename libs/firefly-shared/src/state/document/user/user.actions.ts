...
export class ActionUserReset         { static readonly type = ActionsUser.Reset; }
...
export class ActionUserUpdate        { static readonly type = ActionsUser.Update; }
export class ActionUserSave          { static readonly type = ActionsUser.Save; }
export class ActionUserDelete        { static readonly type = ActionsUser.Delete; }
export class ActionUserWatch         { static readonly type = ActionsUser.Watch;         constructor(public id: string) {} }

export class ActionUserAuthenticate       { static readonly type = ActionsUser.Authenticate; }
...
export class ActionUserResetAll           { static readonly type = ActionsUser.ResetAll; }
...
export class ActionUserNotificationsSet { static readonly type = ActionsUser.NotificationsSet; }
