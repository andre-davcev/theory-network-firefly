export enum Translation {
  ...
  AlertConfirmDeleteHeaderUser = 'alert.confirm.delete.header.user',
  AlertConfirmDeleteMessageUser = 'alert.confirm.delete.message.user',
  AlertConfirmDeleteCancelUser = 'alert.confirm.delete.cancel.user',
