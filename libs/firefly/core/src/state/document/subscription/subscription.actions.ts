...
export class ActionSubscriptionPatchMetadata { static readonly type = ActionsSubscription.PatchMetadata; constructor(public partial: Partial<MetadataInterest>) { } }
