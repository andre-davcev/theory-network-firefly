...
export class ActionUserInterestsAdd     { static readonly type = ActionsUserInterests.Add;     constructor(public snapshot: firestore.DocumentSnapshot, public entity?: Interest) { } }
