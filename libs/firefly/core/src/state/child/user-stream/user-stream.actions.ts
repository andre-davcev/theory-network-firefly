...
export class ActionUserStreamSetData { static readonly type = ActionsUserStream.SetData; constructor(public data: Record<string, StreamInterest>, public fetch: boolean = false) { } }
export class ActionUserStreamGet     { static readonly type = ActionsUserStream.Get;     constructor() { } }
export class ActionUserStreamAdd     { static readonly type = ActionsUserStream.Add;     constructor(public snapshot: firestore.DocumentSnapshot, public entity?: StreamInterest) { } }
export class ActionUserStreamRemove  { static readonly type = ActionsUserStream.Remove;  constructor(public id: string) { } }
export class ActionUserStreamSync    { static readonly type = ActionsUserStream.Sync;    constructor(public object: StreamInterest) { } }
