...
export abstract class StateCollection<
...
> {
  ...
  protected static initializedState(state: any): boolean {
    return state.initialized;
  }
  protected static loadingState(state: any): boolean {
    return state.loading;
  }
  protected static pageSizeState(state: any): number {
    return state.pageSize;
  }
  protected static finishedPagingState(state: any): boolean {
    return state.finishedPaging;
  }
  protected static orderByState(state: any): string {
    return state.orderBy;
  }
  protected static orderByDirectionState(state: any): OrderBy {
    return state.orderByDirection;
  }
  protected static keysState(state: any): Array<string> {
    return state.keys;
  }
  protected static keysFilteredState(state: any): Array<string> {
    return state.keysFiltered || state.keys;
  }
  ...
  protected static dataLookupState(state: any): Record<string, any> {
    return state.dataLookup;
  }
  protected static dataState(state: any): Array<any> {
    return state.data;
  }
  protected static countState(state: any): number {
    return StateCollection.keysState(state).length;
  }
  protected static foundState(state: any): boolean {
    return StateCollection.countState(state) > 0;
  }
  protected static emptyState(state: any): boolean {
    return StateCollection.countState(state) === 0;
  }
  protected static canPageState(state: any): boolean {
    return StateCollection.pageSizeState(state) !== PageSize.None;
  }
  protected static noDataState(state: any): boolean {
    return (
      StateCollection.initializedState(state) &&
      !StateCollection.loadingState(state) &&
      !StateCollection.foundState(state)
    );
  }

  public static initialized() {
    return createSelector([this as any], (state: any) =>
      StateCollection.initializedState(state)
    );
  }
  ...
  public static pageSize() {
    return createSelector([this as any], (state: any) =>
      StateCollection.pageSizeState(state)
    );
  }
  public static finishedPaging() {
    return createSelector([this as any], (state: any) =>
      StateCollection.finishedPagingState(state)
    );
  }
  public static orderBy() {
    return createSelector([this as any], (state: any) =>
      StateCollection.orderByState(state)
    );
  }
  public static orderByDirection() {
    return createSelector([this as any], (state: any) =>
      StateCollection.orderByDirectionState(state)
    );
  }
  public static keys() {
    return createSelector([this as any], (state: any) =>
      StateCollection.keysState(state)
    );
  }
  public static keysFiltered() {
    return createSelector([this as any], (state: any) =>
      StateCollection.keysFilteredState(state)
    );
  }
  public static snapshotLookup() {
    return createSelector([this as any], (state: any) =>
      StateCollection.snapshotLookupState(state)
    );
  }
  public static data() {
    return createSelector([this as any], (state: any) =>
      StateCollection.dataState(state)
    );
  }
  ...
  public static count() {
    return createSelector([this as any], (state: any) =>
      StateCollection.countState(state)
    );
  }
  public static found() {
    return createSelector([this as any], (state: any) =>
  ...
  public static empty() {
    return createSelector([this as any], (state: any) =>
      StateCollection.emptyState(state)
    );
  }
  public static canPage() {
    return createSelector([this as any], (state: any) =>
      StateCollection.canPageState(state)
    );
  }
  public static noData() {
    return createSelector([this as any], (state: any) =>
      StateCollection.noDataState(state)
    );
  }

  public getValue(value: any, type: TypeOf = TypeOf.String): any {
    return type === TypeOf.Timestamp ? value.toDate().getTime() : value;
  }
  ...
  public add(context: StateContext<M>, action: any): Observable<any> {
    ...
    const inLookup: boolean =
      StateCollection.dataLookupState(state)[id] != null;
  ...
  public sync(context: StateContext<M>, action: any): Observable<any> {
    ...
    if (!StateCollection.initializedState(getState())) {
      return of(null);
    }
  ...
  public data(context: StateContext<M>): Array<any> {
    ...
    const state: M = getState();
    const keysFiltered: Array<string> =
      StateCollection.keysFilteredState(state);
    const dataLookup: Record<string, T> =
      StateCollection.dataLookupState(state);

    return keysFiltered.map((id: string) => dataLookup[id]);
  }
  ...
  protected getMediaWithData(
    context: StateContext<M>,
    collection: string,
    imageType: string
  ): Observable<any> {
    const imageSize: ImageSize =
      imageType === ImageType.Icon ? ImageSize.Small : ImageSize.Medium;
    ...
    return of(data).pipe(
      ...
      switchMap((items$: Array<Observable<string>>) => forkJoin(items$)),
      map(() => patchState({ data, dataLookup } as M))
    );
  }
}
