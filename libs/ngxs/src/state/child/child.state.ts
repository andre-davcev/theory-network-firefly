...
import { ImageSize, Model, OrderBy, ServiceFirestore, ActionStorageUrlsGet } from '@theory/firebase';
...
export class StateChild<T extends Model, M extends StateChildModel<T>> extends StateCollection<T, M>
{
