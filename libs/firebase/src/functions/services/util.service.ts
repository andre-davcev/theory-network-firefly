...
export class Util
{
    ...
    public static postCreate(snapshot: DocumentSnapshot, context: EventContext, version: string, patch?: Record<string, any>): Promise<FirebaseFirestore.WriteResult>
    {
    ...
    public static postUpdate(change: Change<DocumentSnapshot>, context: EventContext, patch?: Record<string, any>): Promise<FirebaseFirestore.WriteResult>
    {
