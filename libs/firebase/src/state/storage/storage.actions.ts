...
export class ActionStorageUrlSet  { static readonly type = ActionsStorage.UrlSet;  constructor(public url: string, public bucketPath: string, public size: ImageSize = ImageSize.Medium) { } }

export class ActionStorageUpload      { static readonly type = ActionsStorage.Upload;      constructor(public dataUri: string, public bucketPath: string, public size: ImageSize = ImageSize.Medium) { } }
export class ActionStorageUploadClear { static readonly type = ActionsStorage.UploadClear; constructor() { } }
