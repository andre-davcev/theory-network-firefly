...
const UsersUpdate: CloudFunction<Change<DocumentSnapshot>> = firestore
  ...
  .onUpdate(
    async (
      ...
      const subscriptionsStatusBefore: Record<string, SubscriptionPartial> =
        before.subscriptionsStatus || {};
      const subscriptionsStatusAfter: Record<string, SubscriptionPartial> =
        after.subscriptionsStatus || {};

      const subscriptionKeysBefore: Array<string> = Object.keys(
        subscriptionsStatusBefore
      );
      const subscriptionKeysAfter: Array<string> = Object.keys(
        subscriptionsStatusAfter
      );
