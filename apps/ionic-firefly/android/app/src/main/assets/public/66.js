...
/*!************************************************************************************************************************************!*\
  !*** /Users/andredavcev/Files/Theory/node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/jc49rjp4.sc.entry.js ***!
  \************************************************************************************************************************************/
...
var Menu = /** @class */ (function () {
    ...
    Menu.prototype.sideChanged = function () {
        this.isEndSide = Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["h"])(this.win, this.side);
    };
    ...
    Menu.prototype.onStart = function () {
        if (!this.isAnimating || !this.animation) {
            Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["i"])(false, 'isAnimating has to be true');
            return;
        }
    ...
    Menu.prototype.beforeAnimation = function () {
        Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["i"])(!this.isAnimating, '_before() should not be called while animating');
    ...
    Menu.prototype.afterAnimation = function (isOpen) {
        Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this.isAnimating, '_before() should be called while animating');
        this._isOpen = isOpen;
        this.isAnimating = false;
    ...
    Menu.prototype.updateState = function () {
        ...
        Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["i"])(!this.isAnimating, 'can not be animating');
    };
    Menu.prototype.forceClosing = function () {
        Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["i"])(this._isOpen, 'menu cannot be closed');
        this.isAnimating = true;
...
var MenuButton = /** @class */ (function () {
    ...
    MenuButton.prototype.render = function () {
        ...
        return (Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-menu-toggle", { menu: this.menu, autoHide: this.autoHide }, Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", { type: "button" }, Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("slot", null, Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { icon: menuIcon, mode: this.mode, color: this.color, lazy: false })))));
    };
...
var MenuToggle = /** @class */ (function () {
    ...
    Object.defineProperty(MenuToggle, "style", {
        get: function () { return ".menu-toggle-hidden.sc-ion-menu-toggle-h{display:none}"; },
        enumerable: true,
        configurable: true
    });
    return MenuToggle;
