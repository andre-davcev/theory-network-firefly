...
/*!***************************************************************************************************************************************!*\
  !*** /Users/andredavcev/Projects/theory/node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/7zvak3av.sc.entry.js ***!
  \***************************************************************************************************************************************/
...
var Range = /** @class */ (function () {
    ...
    Range.prototype.debounceChanged = function () {
        this.ionChange = Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["g"])(this.ionChange, this.debounce);
    };
    ...
    Range.prototype.onStart = function (detail) {
        ...
        var ratio = Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(0, (currentX - rect.left) / rect.width, 1);
        this.pressedKnob =
            !this.dualKnobs ||
    ...
    Range.prototype.hostData = function () {
        return {
            class: Object.assign({}, Object(_chunk_b9ec67ac_js__WEBPACK_IMPORTED_MODULE_3__["h"])(this.color), { 'in-item': Object(_chunk_b9ec67ac_js__WEBPACK_IMPORTED_MODULE_3__["j"])('ion-item', this.el), 'range-disabled': this.disabled, 'range-pressed': this.pressedKnob !== undefined, 'range-has-pin': this.pin })
        };
    };
    Range.prototype.render = function () {
        ...
        return [
            ...
            Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "range-slider", ref: function (el) { return _this.rangeSlider = el; } }, ticks.map(function (t) { return (Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { style: { left: t.left }, role: "presentation", class: {
                    'range-tick': true,
                    'range-tick-active': t.active
                } })); }), Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "range-bar", role: "presentation" }), Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "range-bar range-bar-active", role: "presentation", style: {
                    left: barL,
                    right: barR
                } }), renderKnob({
                knob: 'A',
            ...
            Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("slot", { name: "end" })
        ];
    };
...
function renderKnob(_a) {
    ...
    return (Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { onKeyDown: function (ev) {
            var key = ev.key;
            ...
            'left': ratio * 100 + "%"
        }, role: "slider", tabindex: disabled ? -1 : 0, "aria-valuemin": min, "aria-valuemax": max, "aria-disabled": disabled ? 'true' : null, "aria-valuenow": value }, pin && Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "range-pin", role: "presentation" }, Math.round(value)), Object(_ionic_core_js__WEBPACK_IMPORTED_MODULE_1__["h"])("div", { class: "range-knob", role: "presentation" })));
}
function ratioToValue(ratio, min, max, step) {
    ...
    return Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(min, value, max);
}
function valueToRatio(value, min, max) {
    return Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["j"])(0, (value - min) / (max - min), 1);
}
