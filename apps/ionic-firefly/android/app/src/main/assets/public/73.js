...
/*!*********************************************************************************************************************************!*\
  !*** /Users/andredavcev/Files/Theory/node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/ldpcwjk1.entry.js ***!
  \*********************************************************************************************************************************/
...
function importHardwareBackButton(win) {
    if (Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(win, 'hybrid')) {
        __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.bind(null, /*! ./hardware-back-button.js */ "../../node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/hardware-back-button.js")).then(function (module) { return module.startHardwareBackButton(win); });
    }
}
function importStatusTap(win, queue) {
    if (Object(_chunk_e7816c0b_js__WEBPACK_IMPORTED_MODULE_2__["m"])(win, 'hybrid')) {
        __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.bind(null, /*! ./status-tap.js */ "../../node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/status-tap.js")).then(function (module) { return module.startStatusTap(win, queue); });
    }
}
function importTapClick(win) {
    __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./tap-click.js */ "../../node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/tap-click.js")).then(function (module) { return module.startTapClick(win.document); });
}
function importInputShims(win, config) {
    var inputShims = config.getBoolean('inputShims', needInputShims(win));
    if (inputShims) {
        __webpack_require__.e(/*! import() */ 6).then(__webpack_require__.bind(null, /*! ./input-shims.js */ "../../node_modules/@ionic/angular/node_modules/@ionic/core/dist/esm/es5/build/input-shims.js")).then(function (module) { return module.startInputShims(win.document, config); });
    }
}
...
var Content = /** @class */ (function () {
    ...
    Content.prototype.hostData = function () {
        return {
            class: Object.assign({}, Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["d"])(this.color), { 'content-sizing': Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["f"])('ion-popover', this.el), 'overscroll': !!this.forceOverscroll }),
            style: {
...
var Footer = /** @class */ (function () {
    ...
    Footer.prototype.hostData = function () {
        var themedClasses = Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.mode, 'footer');
        var translucentClasses = this.translucent ? Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.mode, 'footer-translucent') : null;
        return {
...
var Header = /** @class */ (function () {
    ...
    Header.prototype.hostData = function () {
        var themedClasses = Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.mode, 'header');
        var translucentClasses = this.translucent ? Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.mode, 'header-translucent') : null;
        return {
            class: Object.assign({}, themedClasses, translucentClasses)
        };
    };
...
var ToolbarTitle = /** @class */ (function () {
    ...
    ToolbarTitle.prototype.hostData = function () {
        ...
        return {
            class: Object.assign({}, Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["d"])(this.color), (_a = {}, _a["title-" + mode] = true, _a))
        };
    };
    ...
    Object.defineProperty(ToolbarTitle, "style", {
        get: function () { return ":host{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-flex:1;-ms-flex:1;flex:1;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-transform:translateZ(0);transform:translateZ(0)}:host(.title-ios){left:0;top:0;padding:0 90px;position:absolute;width:100%;height:100%;-webkit-transform:translateZ(0);transform:translateZ(0);font-size:17px;font-weight:600;letter-spacing:-.03em;text-align:center;-webkit-box-sizing:border-box;box-sizing:border-box;pointer-events:none}:host(.title-md){padding:0 12px;font-size:20px;font-weight:500}:host(.ion-color){color:var(--ion-color-base)}.toolbar-title{display:block;width:100%;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;pointer-events:auto}"; },
        enumerable: true,
        configurable: true
    });
    return ToolbarTitle;
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.hostData = function () {
        return {
            class: Object(_chunk_50fe9317_js__WEBPACK_IMPORTED_MODULE_3__["d"])(this.color)
        };
    };
    ...
    Object.defineProperty(Toolbar, "style", {
        get: function () { return ":host{--border-width:0;--border-style:solid;--opacity:1;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;display:block;position:relative;width:100%;color:var(--color);font-family:var(--ion-font-family,inherit);contain:content;z-index:10;-webkit-box-sizing:border-box;box-sizing:border-box;--background:var(--ion-toolbar-background-color, #f8f8f8);--color:var(--ion-toolbar-text-color, #424242);--border-color:var(--ion-toolbar-border-color, var(--ion-border-color, #c1c4cd));--padding-top:4px;--padding-bottom:4px;--padding-start:4px;--padding-end:4px;--min-height:56px}:host(.ion-color){color:var(--ion-color-contrast)}:host(.ion-color) .toolbar-background{background:var(--ion-color-base)}.toolbar-container{padding:var(--padding-top) var(--padding-end) var(--padding-bottom) var(--padding-start);display:-webkit-box;display:-ms-flexbox;display:flex;position:relative;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;width:100%;min-height:var(--min-height);contain:content;overflow:hidden;z-index:10;-webkit-box-sizing:border-box;box-sizing:border-box}.toolbar-background{left:0;right:0;top:0;bottom:0;position:absolute;-webkit-transform:translateZ(0);transform:translateZ(0);border-width:var(--border-width);border-style:var(--border-style);border-color:var(--border-color);background:var(--background);contain:strict;opacity:var(--opacity);z-index:-1;pointer-events:none}.toolbar-content{-webkit-box-flex:1;-ms-flex:1;flex:1;-webkit-box-ordinal-group:4;-ms-flex-order:3;order:3;min-width:0;max-width:100%}"; },
        enumerable: true,
        configurable: true
    });
