...
function startTapClick(t) { var e, n, o = 10 * -MOUSE_WAIT, i = 0, a = !1; var s = new WeakMap; function c(t) { o = Object(_chunk_76b36062_js__WEBPACK_IMPORTED_MODULE_0__["a"])(t), d(t); } function r() { clearTimeout(n), e && (A(!1), e = void 0), a = !0; } function E(t) { e || (a = !1, u(getActivatableTarget(t), t)); } function d(t) { u(void 0, t), a && t.cancelable && t.preventDefault(); } function u(t, o) { if (t && t === e)
    ...
    e.classList.contains(ACTIVATED) || T(e, i, a), A(!0);
} if (t) {
    var e_1 = s.get(t);
    e_1 && (clearTimeout(e_1), s.delete(t)), t.classList.remove(ACTIVATED), n = setTimeout(function () { T(t, i, a), n = void 0; }, ADD_ACTIVATED_DEFERS);
} e = t; } function T(t, e, n) { i = Date.now(), t.classList.add(ACTIVATED); var o = new CustomEvent("ionActivated", { bubbles: !1, detail: { x: e, y: n } }); t.dispatchEvent(o); } function A(t) { var n = e; if (!n)
...
function getActivatableTarget(t) { if (!t.composedPath)
    ...
    for (var t_2 = 0; t_2 < e.length - 2; t_2++) {
        var n = e[t_2];
        if (n.hasAttribute && n.hasAttribute("ion-activable"))
            return n;
    }
} }
